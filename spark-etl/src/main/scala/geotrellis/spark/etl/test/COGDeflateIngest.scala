...
object COGDeflateIngest {
  def main(args: Array[String]): Unit = {
    implicit val sc = SparkUtils.createSparkContext("GeoTrellis COG Deflate NLCD Ingest", new SparkConf(true))
    val reader = LayerReader("s3://azavea-datahub/catalog")
    val attributeStore = new S3AttributeStore("geotrellis-test", "daunnc/new-test-deflate2")
    ...
    writer.write("nlcd-tms-epsg3857-cog", layer, 12, ZCurveKeyIndexMethod, DeflateCompression)
  }
}
